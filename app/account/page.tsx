...
const AccountPage = () => {
  ...
  return (
    <div className="min-h-[calc(100vh-80px)] flex items-center justify-center bg-slate-50 p-4 md:p-8">
          ...
          <div className="relative z-10">
            ...
            <div className="mt-12 space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-bold text-lg leading-tight">Fastest Delivery</h3>
                  <p className="text-blue-100/70 text-xs mt-1">Get your products delivered to your doorstep in record time.</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="p-3 bg-white/10 rounded-2xl shrink-0">
                ...
                <div>
                  <h3 className="font-bold text-lg leading-tight">Secure Shopping</h3>
                  <p className="text-blue-100/70 text-xs mt-1">Your data and payments are protected by military-grade security.</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="p-3 bg-white/10 rounded-2xl shrink-0">
                ...
                <div>
                  <h3 className="font-bold text-lg leading-tight">24/7 Support</h3>
                  <p className="text-blue-100/70 text-xs mt-1">Our dedicated team is always here to help you anytime.</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="p-3 bg-white/10 rounded-2xl shrink-0">
                ...
                <div>
                  <h3 className="font-bold text-lg leading-tight">Easy Returns</h3>
                  <p className="text-blue-100/70 text-xs mt-1">Not satisfied? Return any product within 30 days, no questions asked.</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="p-3 bg-white/10 rounded-2xl shrink-0">
                ...
                <div>
                  <h3 className="font-bold text-lg leading-tight">Best Prices</h3>
                  <p className="text-blue-100/70 text-xs mt-1">We guarantee the most competitive prices in the market.</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="p-3 bg-white/10 rounded-2xl shrink-0">
                ...
                <div>
                  <h3 className="font-bold text-lg leading-tight">Quality Products</h3>
                  <p className="text-blue-100/70 text-xs mt-1">Every product is verified for quality and authenticity.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="relative z-10">
            <div className="p-6 bg-white/5 rounded-3xl border border-white/10 backdrop-blur-sm">
              <p className="italic text-blue-50 text-sm">
                &quot;The best shopping experience I&apos;ve ever had. Simple, fast, and reliable!&quot;
              </p>
