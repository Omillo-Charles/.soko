    ...
    <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="flex items-center gap-6 md:gap-12">
              ...
              <div className="relative shrink-0">
                ...
                <div className="relative w-24 h-24 md:w-40 md:h-40 p-2 rounded-[3rem] bg-gradient-to-br from-primary/50 to-secondary/50 backdrop-blur-md shadow-2xl">
                  <div className="w-full h-full rounded-[2.6rem] overflow-hidden bg-background/80 border border-white/20">
                    <img
      ...
      <div className="grid grid-cols-1 xl:grid-cols-[1fr_420px] gap-10">
              ...
              orders.slice(0, 5).map((o) => (
                <div key={o._id} className="group flex flex-col md:flex-row md:items-center justify-between p-8 bg-background/40 backdrop-blur-3xl rounded-[2.5rem] border border-white/10 hover:shadow-[0_20px_40px_rgba(0,0,0,0.1)] hover:border-primary/30 transition-all duration-500 gap-6">
                  ...
                  <div className="flex items-center justify-between md:text-right gap-8">
                    ...
                    <Link href={`/account/seller-orders`} className="p-4 bg-background/60 hover:bg-primary hover:text-white rounded-2xl transition-all duration-500 shadow-lg border border-white/5">
        ...
        <div className="space-y-10">
          <div className="space-y-6">
            ...
            <div className="bg-background/40 backdrop-blur-3xl rounded-[3.5rem] border border-white/10 p-4 space-y-4 shadow-2xl">
              {products.length === 0 ? (
                ...
                products.slice(0, 5).map((p: any) => (
                  <Link
                    ...
                    className="flex items-center gap-5 p-4 rounded-[2.5rem] hover:bg-white/5 transition-all group border border-transparent hover:border-white/5"
                  >
              ...
              {products.length > 5 && (
                <Link 
                  href="/account/products"
                  className="block w-full text-center py-6 text-xs font-black text-primary uppercase tracking-[0.3em] border-t border-white/5 hover:bg-primary/5 rounded-b-[2.5rem] transition-all duration-500"
                >
          ...
          <div className="bg-gradient-to-br from-indigo-700 via-purple-700 to-indigo-900 rounded-[3.5rem] p-10 text-white relative overflow-hidden shadow-[0_30px_60px_rgba(79,70,229,0.3)] group cursor-pointer border border-white/10">
