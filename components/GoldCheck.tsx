    ...
    >
      <defs>
        <linearGradient id="gold-gradient" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#fbbf24" />    {/* lighter gold */}
          <stop offset="50%" stopColor="#f59e0b" />   {/* mid gold */}
          <stop offset="100%" stopColor="#b45309" />  {/* deeper gold shadow */}
        </linearGradient>
      </defs>
      <g>
        {/* Rosette / badge shape – filled with gold gradient */}
        <path
